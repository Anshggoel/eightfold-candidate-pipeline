    ...
    def _parse_json(self, file_path):
        try:
            ...
            for item in data.get("candidates", []):
                ...
                # 🔥 GOLDEN UPDATE: Real-world Email Validation Check
                # Agar bache ne galat format mein email dala (jaise ansh.com bina @ ke), toh pipeline crash nahi hoga, skip karega.
